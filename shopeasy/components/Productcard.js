...
const ProductCard = ({ item }) => {
  ...
  return (
      <Link href={`product/${item._id}`}>
        <div className="group bg-white relative hover:shadow-xl duration-300 pb-[26rem] m-4 p-5 pt-0 w-full h-[400px] border rounded-lg hover:transform hover:scale-105 ease-in-out transform transition-transform">
          {/* Heart Icon on hover */}
          ...
          <div className="flex flex-col space-y-2 mt-3">
            ...
            {/* Product Name */}
            <h2 className="font-semibold text-lg text-[#253D4E] line-clamp-2">
              {item.name}
            </h2>
