...
const NotLoggedInPage = () => {
    return (
        <div className="w-[40vw] m-auto mt-10 text-center bg-white p-8 rounded-lg shadow-lg">
            ...
            <p className="text-lg text-gray-700 mb-4">You need to be logged in to view your account, orders and other things.</p>
            ...
            <p className="text-sm text-gray-500 mt-4">Don&lsquo;t have an account? <Link href="/signup" className="text-green-600 hover:underline">Register here</Link>.</p>
        </div>
    );
};
